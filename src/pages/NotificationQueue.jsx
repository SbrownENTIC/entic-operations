      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-blue-700 text-sm">Records with <strong>Status = Ready to Send</strong> and <strong>Ready to Send = true</strong> and a blank Sent Date will be picked up by Power Automate and sent from <strong>Steve.brown@enticmd.com</strong>. After send, Power Automate updates Status → Sent and populates Sent Date.</p>
          </div>
        </div>
