                        ...
                        <tr>
                          {TABLE_COLS.map(col => (
                            <th
                              ...
                              className="text-left px-4 py-2.5 text-xs font-semibold text-slate-600 whitespace-nowrap cursor-pointer select-none hover:bg-slate-100 transition-colors"
                            >
