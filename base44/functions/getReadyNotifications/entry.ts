  ...
  try {
    ...
    return Response.json({
      ...
      notifications: ready.map(n => ({
        ...
        attachment_mime_type: n.attachment_mime_type || '',
        attachment_content_base64: n.attachment_content_base64 || '',
        power_automate_attachment_name: n.power_automate_attachment_name || n.attachment_filename || '',
        power_automate_attachment_content_base64: n.power_automate_attachment_content_base64 || n.attachment_content_base64 || '',
        power_automate_attachment_mime_type: n.power_automate_attachment_mime_type || n.attachment_mime_type || '',
        attachments:          n.attachments || [],
        outlook_attachments:  n.outlook_attachments || [],
        attachment_count:     n.attachment_count || 0,
